...
const BillingPage = () => {
  ...
  const fetchSubscription = async () => {
    try {
      ...
      // Set subscription to null so we show the subscription plans
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-800">
                  <strong>Backend Connection Issue:</strong> Subscription management is currently experiencing connection issues. 
                  The payment interface is fully functional for testing purposes.
                </p>
              </div>
            </div>
          </div>
